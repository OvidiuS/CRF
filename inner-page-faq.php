...
$contentTemplateName = "./content-templates/inner-page-faq-content.inc";
...
// with the 2 lines of code above, we're saying we want to load the inner page content into a page with a left-sidebar column layout.
?>