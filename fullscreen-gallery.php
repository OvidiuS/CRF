...
<meta charset="utf-8">
<title>Camp Firebird and Roosevelt – Photo Galleries</title>
...
#menu {
	...
	right: 10px;
	z-index: 11000;
	background:rgb(20, 32, 74);
	background:rgba(20, 32, 74, 0.61);
	padding: 5px 5px 4px;
	border-radius: 5px;
...
<!-- load Galleria -->
<script src="<?= $config->urls->templates?>js/galleria-1.2.8.min.js"></script>

<!-- load flickr plugin -->
<script src="<?= $config->urls->templates?>js/plugins/flickr/galleria.flickr.min.js"></script>
</head>
<body>
<?= $page->id ?>
<div class="logo"><a href="/"><img src="/site/templates/images/FirebirdRoosevelt-Logos.png" alt="Camp Firebird and Roosevelt" /></a> <a href="/" class="backToWebsite">&laquo; back to website</a> </div>
<!-- end logo-->
